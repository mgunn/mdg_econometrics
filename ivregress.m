function [results, options] = ivregress(varargin)
...
%%                 Set Options                   %%
if(nargin < 4)
    error('need at least 4 arguments: y, endo, exo, and instruments');
end
...
if(isempty(exo))
    [y, endo, instruments] = mdgtools.removenan(y, endo, instruments);
else
    [y, endo, exo, instruments] = mdgtools.removenan(y, endo, exo, instruments);
end
